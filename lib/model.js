...
function Model(table, connectionString) {
  this.table = table;
  this.connectionString = connectionString;
  this.attributes = {};
}

Model.define = function(table, connectionString) {
  var self = new Model(table, connectionString);
...
Model.prototype.get = function(id) {
  var query = select().from(this.table).where({id: id}).toParams();
